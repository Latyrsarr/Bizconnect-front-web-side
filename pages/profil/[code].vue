          ...
          <div class="bg-white border-2 border-gray-200 rounded-2xl p-5 mb-4">
            ...
            <div class="space-y-3">
              <div v-if="profile.num_contact" class="flex items-center gap-3">
                ...
                <a :href="`tel:${profile.num_contact}`" class="text-gray-700 hover:text-blue-600 transition">{{ profile.num_contact }}</a>
              </div>
          ...
          <div class="bg-white border-2 border-gray-200 rounded-2xl p-5">
            ...
            <div class="space-y-3">
              <div v-if="profile.num_entreprise" class="flex items-center gap-3">
                ...
                <a :href="`tel:${profile.num_entreprise}`" class="text-gray-700 hover:text-blue-600 transition">{{ profile.num_entreprise }}</a>
              </div>
